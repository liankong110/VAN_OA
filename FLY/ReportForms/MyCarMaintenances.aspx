<%@ Page Language="C#" AutoEventWireup="True" Culture="auto" UICulture="auto" CodeBehind="MyCarMaintenances.aspx.cs"
    Inherits="VAN_OA.ReportForms.MyCarMaintenances" MasterPageFile="~/DefaultMaster.Master"
    Title="车辆保养记录表" %>
        ...
        <asp:LinkButton ID="lbnNext" runat="Server" Text="下一页" Enabled='<%# ((GridView)Container.NamingContainer).PageIndex != (((GridView)Container.NamingContainer).PageCount - 1) %>' CommandName="Page" CommandArgument="Next" ></asp:LinkButton>
         ...
         <br />--%>
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="MaintenanceTime" HeaderText="保养时间点" SortExpression="MaintenanceTime"
        ...
        <cc1:TabPanel ID="TabPanel2" runat="server">
            ...
            <ContentTemplate>
                ...
                <asp:GridView ID="gvOil" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
                    DataKeyNames="Id" Width="100%" AllowPaging="false" AutoGenerateColumns="False"
                    OnRowDataBound="gvOil_RowDataBound">
                    <PagerTemplate>
                        <br />
                        <%--   <asp:Label ID="lblPage" runat="server" Text='<%# "第" + (((GridView)Container.NamingContainer).PageIndex + 1)  + "页/共" + (((GridView)Container.NamingContainer).PageCount) + "页" %> '></asp:Label>
        <asp:LinkButton ID="lbnFirst" runat="Server" Text="首页"  Enabled='<%# ((GridView)Container.NamingContainer).PageIndex != 0 %>' CommandName="Page" CommandArgument="First" ></asp:LinkButton>
