<%@ Page Language="C#" AutoEventWireup="True" Culture="auto" UICulture="auto" CodeBehind="MyOverTimeList.aspx.cs"
    Inherits="VAN_OA.ReportForms.MyOverTimeList" MasterPageFile="~/DefaultMaster.Master"
    Title="个人加班记录" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    ...
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="reason" HeaderText="加班/调休原因" SortExpression="reason" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="guestDai" HeaderText="客户代表" SortExpression="guestDai"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="SuixingRen" HeaderText="随行人" SortExpression="SuixingRen"
                ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="OverTimeType" HeaderText="类型" SortExpression="OverTimeType"
                ItemStyle-HorizontalAlign="Center" />
