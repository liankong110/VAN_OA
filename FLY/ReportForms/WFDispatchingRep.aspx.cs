...
{
    public partial class WFDispatchingRep : System.Web.UI.Page
    {
        private tb_DispatchingService DispatchingSer = new tb_DispatchingService();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!base.IsPostBack)
            {
                ...
                select();
                //List<DispatchingRep> users = this.DispatchingSer.GetListArrayReport("");
                //this.gvList.DataSource = users;
                //this.gvList.DataBind();
            }
        }
        ...
        protected void gvList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "SeeFile")
            {
                ...
                string url = Server.MapPath("~")+@"EFrom\Dispatching\" + e.CommandArgument;
