<%@ Page Language="C#" AutoEventWireup="True" Culture="auto" UICulture="auto" CodeBehind="ProjectInvsList.aspx.cs"
    Inherits="VAN_OA.ReportForms.ProjectInvsList" MasterPageFile="~/DefaultMaster.Master"
    Title="工程材料审计清单管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    ...
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="LoginName" HeaderText="用户" SortExpression="LoginName"
                ItemStyle-HorizontalAlign="Center" />
