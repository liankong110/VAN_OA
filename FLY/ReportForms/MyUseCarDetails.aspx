<%@ Page Language="C#" AutoEventWireup="True" Culture="auto" UICulture="auto" CodeBehind="MyUseCarDetails.aspx.cs"
    Inherits="VAN_OA.ReportForms.MyUseCarDetails" MasterPageFile="~/DefaultMaster.Master"
    Title="司机公里数统计" %>
                ...
                <asp:Panel ID="Panel1" runat="server" Width="100%" ScrollBars="Horizontal" Height="100%">
                    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GuestName" HeaderText="公司名称" SortExpression="GuestName"
                                ItemStyle-HorizontalAlign="Center" />
