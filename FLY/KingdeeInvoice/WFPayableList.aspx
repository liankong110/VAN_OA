<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="WFPayableList.aspx.cs"
    Inherits="VAN_OA.KingdeeInvoice.WFPayableList" MasterPageFile="~/DefaultMaster.Master"
    Title="金蝶应付发票清单" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="4" style="height: 20px; background-color: #336699; color: White;">金蝶应付发票清单
            </td>
        </tr>
        <tr>
            <td>开具日期:
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlDaoZhang" runat="server">
                    ...
                    <asp:ListItem Value="2">未全支付</asp:ListItem>
                </asp:DropDownList>
                Isorder:
