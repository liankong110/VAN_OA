<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_PATemplateList.aspx.cs"
    Inherits="VAN_OA.Performance.A_PATemplateList" MasterPageFile="~/DefaultMaster.Master"
    Title="绩效考核模版管理" %>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加考核模版" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        DataKeyNames="A_PATemplateId" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="复制">
                <ItemTemplate>
                    ...
                    <asp:ImageButton ID="btnCopy" runat="server" ImageUrl="~/Image/Copy.PNG" AlternateText="复制"
                        CommandName="Update"/>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="A_PATemplateName" HeaderText="绩效考核模版名称">
