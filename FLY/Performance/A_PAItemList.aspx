<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="A_PAItemList.aspx.cs" Inherits="VAN_OA.Performance.A_PAItemList"  MasterPageFile="~/DefaultMaster.Master" Title="绩效考核项管理"%>

 <asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
     <table cellpadding="0" cellspacing="0" width="90%" bordercolorlight="#999999" bordercolordark="#FFFFFF" border="1">
     <tr>
        <td colspan="8" style=" height:20px; background-color:#336699; color:White;">绩效考核项管理</td>
    </tr>
    <tr>
        <td>考核项</td>
        <td><asp:TextBox ID="txtName" runat="server"></asp:TextBox> &nbsp;
            ...
            <asp:Button ID="btnAdd" runat="server" Text="添加考核项"  BackColor="Yellow" 
                onclick="btnAdd_Click" />
        </td>
    </tr>
</table><br>
<asp:GridView ID="gvList" runat="server"   BorderColor="#FBFBFB" 
    BorderStyle="Solid"  DataKeyNames="A_PAItemId"  
    ...
    <Columns>
        <asp:TemplateField HeaderText=" 编辑">
         ...
         <asp:BoundField DataField="A_PAItemName" HeaderText="绩效考核项名称"  >
