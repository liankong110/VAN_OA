<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyEFormsTodo.aspx.cs" Culture="auto"
    UICulture="auto" Inherits="VAN_OA.EFrom.MyEFormsTodo" MasterPageFile="~/DefaultMaster.Master"
    Title="我要审批的单据" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtPONo" runat="server" Width="200px"></asp:TextBox> AE：
