<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyAppEForms.aspx.cs" Culture="auto"
    UICulture="auto" Inherits="VAN_OA.EFrom.MyAppEForms" MasterPageFile="~/DefaultMaster.Master"
    Title="我审批过的单据" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    ...
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Type1" HeaderText="委托人">
                <ItemStyle HorizontalAlign="Center" BorderColor="#E5E5E5" />
            </asp:BoundField>
