<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Complaint.aspx.cs" Culture="auto" UICulture="auto" Inherits="VAN_OA.EFrom.Complaint" MasterPageFile="~/DefaultMaster.Master" Title="内  部  投  诉  单" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF" border="1">
        <tr>
            <td colspan="6" style="height: 20px; background-color: #336699; color: White;">内部投诉单-<asp:Label ID="lblProNo" runat="server" Text=""></asp:Label></td>
        </tr>
        <tr>
            <td>投诉人：<font style="color: Red">*</font></td>
            <td>
            ...
            <td>
                ...
                <cc1:CalendarExtender ID="CalendarExtender3" runat="server" Format="yyyy-MM-dd hh:mm:ss" TargetControlID="txtDateTime">
                </cc1:CalendarExtender>
            </td>
            <td>被 投 诉 人：<font style="color: Red">*</font></td>
            <td>
                <asp:TextBox ID="txtToPer" runat="server"></asp:TextBox></td>

        </tr>


        <tr>
            <td>投诉内容：<font style="color: Red">*</font>
            </td>
            <td colspan="5">
