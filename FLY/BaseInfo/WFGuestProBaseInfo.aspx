...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="2" style="height: 20px; background-color: #336699; color: White;">客户属性
            </td>
        </tr>
        <tr>
            <td height="25" width="30%" align="right">客户属性 ：
            </td>
        ...
        <tr>
            <td height="25" width="30%" align="right">激励系数 ：
            </td>
            <td height="25" width="*" align="left">
        ...
        <tr>
            <td height="25" width="30%" align="right">系数可变 ：
            </td>
            <td height="25" width="*" align="left">
        ...
        <tr>
            <td height="25" width="30%" align="right">有效期 ：
            </td>
            <td height="25" width="*" align="left">
