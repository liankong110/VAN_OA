<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFUseTypeList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFUseTypeList" MasterPageFile="~/DefaultMaster.Master"
    Title="银行票据用途" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加银行票据用途" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="删除">
              ...
              <asp:BoundField DataField="Type_String" HeaderText="类型" SortExpression="Type_String" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Name" HeaderText="用途" SortExpression="Name" ItemStyle-HorizontalAlign="Center" />
