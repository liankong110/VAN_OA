<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestTypeBaseInfoList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.GuestTypeBaseInfoList" MasterPageFile="~/DefaultMaster.Master"
    Title="客户类型列表" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加客户类型" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="PayXiShu" HeaderText="结算系数" SortExpression="PayXiShu"
                ItemStyle-HorizontalAlign="Center" />
