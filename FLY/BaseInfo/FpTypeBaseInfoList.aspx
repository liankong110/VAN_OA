<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FpTypeBaseInfoList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.FpTypeBaseInfoList" MasterPageFile="~/DefaultMaster.Master"
    Title="商品档案" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加发票类型" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FpType" HeaderText="发票类型" SortExpression="FpType" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Tax" HeaderText="税率" SortExpression="Tax" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="FpLength" HeaderText="发票长度" SortExpression="FpLength"
