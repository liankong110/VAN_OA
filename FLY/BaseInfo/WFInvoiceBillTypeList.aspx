<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFInvoiceBillTypeList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFInvoiceBillTypeList" MasterPageFile="~/DefaultMaster.Master"
    Title="财务票据类型管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加财务票据类型" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <EmptyDataTemplate>
            <table width="100%">
                <tr style="height: 20px; background-color: #336699; color: White;">
                    ...
                    <td height="25" align="center">票据名称
                    </td>
                    <td height="25" align="center">格式文件
                    </td>
                    <td height="25" align="center">是否停用
                    </td>
                    <tr>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BillName" HeaderText="票据名称" SortExpression="BillName" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="BillType" HeaderText="格式文件" SortExpression="BillType" ItemStyle-HorizontalAlign="Center" />
