<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFWarnDaysList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFWarnDaysList" MasterPageFile="~/DefaultMaster.Master"
    Title="流程警示天数" %>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加流程警示天数" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="名称" SortExpression="Name" ItemStyle-HorizontalAlign="Center" />
              <asp:BoundField DataField="WarnDays" HeaderText="警示天数" SortExpression="WarnDays" ItemStyle-HorizontalAlign="Center" />
        </Columns>
