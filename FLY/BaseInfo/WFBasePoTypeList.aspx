<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFBasePoTypeList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFBasePoTypeList" MasterPageFile="~/DefaultMaster.Master"
    Title="项目类别" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加项目类别" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BasePoType" HeaderText="名称" SortExpression="BasePoType" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Reward" HeaderText="奖励系数" SortExpression="Reward" ItemStyle-HorizontalAlign="Center" />
        </Columns>
