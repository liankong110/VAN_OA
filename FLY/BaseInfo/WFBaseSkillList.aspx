<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFBaseSkillList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFBaseSkillList" MasterPageFile="~/DefaultMaster.Master"
    Title="工程技术考核系数" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加工程技术考核系数" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <EmptyDataTemplate>
            <table width="100%">
                <tr style="height: 20px; background-color: #336699; color: White;">
                    ...
                    <td height="25" align="center">项目类别
                    </td>
                    <td height="25" align="center">考核系数
                    </td>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="MyPoType" HeaderText="项目类别" SortExpression="MyPoType" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="XiShu" HeaderText="考核系数" SortExpression="XiShu" ItemStyle-HorizontalAlign="Center" />
        </Columns>
