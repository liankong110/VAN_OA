<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFInvoicePersonList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFInvoicePersonList" MasterPageFile="~/DefaultMaster.Master"
    Title="财务票据人员管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加财务票据人员" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="人员姓名" SortExpression="Name" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="CardNo" HeaderText="身份证号" SortExpression="CardNo" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="Phone" HeaderText="手机号" SortExpression="Phone" ItemStyle-HorizontalAlign="Center" />
