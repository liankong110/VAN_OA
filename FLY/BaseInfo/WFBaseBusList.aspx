<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFBaseBusList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFBaseBusList" MasterPageFile="~/DefaultMaster.Master"
    Title="公交卡管理" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtBusNo" runat="server" Width="200px"></asp:TextBox>
            </td>
        </tr>
        <tr>
    ...
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BusNo" HeaderText="公交卡号" SortExpression="BusNo" ItemStyle-HorizontalAlign="Center" />
             ...
             <asp:TemplateField HeaderText="是否停用">               
              ...
              <asp:BoundField DataField="CreateTime" HeaderText="新建日期" SortExpression="CreateTime" ItemStyle-HorizontalAlign="Center" />
        </Columns>
