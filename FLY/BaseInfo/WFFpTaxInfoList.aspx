<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFFpTaxInfoList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFFpTaxInfoList" MasterPageFile="~/DefaultMaster.Master"
    Title="商品档案" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加发票税收点数" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tax" HeaderText="发票税收点数" SortExpression="Tax" ItemStyle-HorizontalAlign="Center" />
        </Columns>
