<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CaiOilXSInfoList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.CaiOilXSInfoList" MasterPageFile="~/DefaultMaster.Master"
    Title="商品档案" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加油价系统" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="OilXs" HeaderText="系数" SortExpression="OilXs" ItemStyle-HorizontalAlign="Center" />
        </Columns>
