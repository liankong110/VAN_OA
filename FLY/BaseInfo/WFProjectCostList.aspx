<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFProjectCostList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFProjectCostList" MasterPageFile="~/DefaultMaster.Master"
    Title="项目成本系数设置" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加项目成本系数" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <EmptyDataTemplate>
            <table width="100%">
                <tr style="height: 20px; background-color: #336699; color: White;">
                    ...
                    <tr>
                        <td colspan="5" align="center" style="height: 80%">
                            ---暂无数据---
                        </td>
                    </tr>
            </table>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ZhangQi" HeaderText="成本账期" SortExpression="ZhangQi" ItemStyle-HorizontalAlign="Right" />
            <asp:BoundField DataField="CeSuanDian" HeaderText="成本测算" SortExpression="CeSuanDian" ItemStyle-HorizontalAlign="Right" />
              <asp:BoundField DataField="MonthLiLv" HeaderText="成本月利率" SortExpression="MonthLiLv" ItemStyle-HorizontalAlign="Right" />
        </Columns>
