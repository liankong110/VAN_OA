<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFModelList.aspx.cs"
    Inherits="VAN_OA.BaseInfo.WFModelList" MasterPageFile="~/DefaultMaster.Master"
    Title="项目模型设置" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SampleContent" runat="server">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="2" align="right">
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加工项目模型" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <EmptyDataTemplate>
            <table width="100%">
                <tr style="height: 20px; background-color: #336699; color: White;">
                    ...
                    <td height="25" align="center">模型名称 
                    </td>
                    <td height="25" align="center">模型说明
                    </td>
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ModelName" HeaderText="模型名称" SortExpression="MyPoType" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="ModelRemark" HeaderText="模型说明" SortExpression="XiShu" ItemStyle-HorizontalAlign="Center" />
        </Columns>
