<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CAI_OrderOutHouseList.aspx.cs"
    Inherits="VAN_OA.JXC.CAI_OrderOutHouseList" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="采购订单列表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="6" style="height: 20px; background-color: #336699; color: White;">采购退货列表
            </td>
        </tr>
        <tr>
            <td>项目编号:
    ...
    采购退货金额合计：<asp:Label ID="lblTotal" runat="server" Text="0" Style="color: Red;"></asp:Label>
</asp:Content>
