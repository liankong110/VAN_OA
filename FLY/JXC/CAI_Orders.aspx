<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CAI_Orders.aspx.cs" Inherits="VAN_OA.JXC.CAI_Orders" Culture="auto" UICulture="auto"  ValidateRequest="false"%>
...
<body style="font-size:12px;">
 ...
 <tr><td height="25" width="30%" align="right">
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtGoodNo" runat="server" Width="300px"  
               ></asp:TextBox></tr>
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtInvName" runat="server" Width="300px"  
             onblur="CheckId();"  ></asp:TextBox>
          ...
          <cc1:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" ServicePath="../MyWebService/MyWebService.asmx"
            ...
            TargetControlID="txtInvName"></cc1:AutoCompleteExtender>
	...
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtNum" runat="server" Width="300px"  onKeyUp="count3();"  
		 ...
		 <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="格式有误" ValidationGroup="a"  ControlToValidate="txtNum" ValidationExpression="^[0-9]+(.[0-9]{2})?$" >
