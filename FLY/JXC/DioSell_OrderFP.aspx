<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DioSell_OrderFP.aspx.cs"
    Inherits="VAN_OA.JXC.DioSell_OrderFP" %>
        ...
        <asp:LinkButton ID="lbnNext" runat="Server" Text="下一页" Enabled='<%# ((GridView)Container.NamingContainer).PageIndex != (((GridView)Container.NamingContainer).PageCount - 1) %>' CommandName="Page" CommandArgument="Next" ></asp:LinkButton>
         ...
         <br />--%>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="FPNo" HeaderText="发票号" SortExpression="FPNo" ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="FPNoStyle" HeaderText="发票类型" SortExpression="FPNoStyle"
                    ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="sumTotal" HeaderText="已到金额" SortExpression="sumTotal"
                    ItemStyle-HorizontalAlign="Center" />
                <asp:BoundField DataField="chaTotals" HeaderText="未到金额" SortExpression="chaTotals"
                    ItemStyle-HorizontalAlign="Center" />
            </Columns>
