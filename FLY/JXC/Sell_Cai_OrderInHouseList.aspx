<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sell_Cai_OrderInHouseList.aspx.cs"
    Inherits="VAN_OA.JXC.Sell_Cai_OrderInHouseList" Culture="auto" UICulture="auto"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="6" style="height: 20px; background-color: #336699; color: White;">销售退货未采退列表
            </td>
        </tr>
        <tr>
            <td>项目编号:
            ...
            <td>
                <asp:TextBox ID="ttxPOName" runat="server" Width="200PX"></asp:TextBox>公司名称：
        ...
        <tr>
            ...
            <td colspan="4">--%>
                ...
                </asp:DropDownList>项目模型:  <asp:DropDownList ID="ddlModel" DataTextField="ModelName" DataValueField="ModelName" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
            <td colspan="4">
                <div style="float: left; display: inline;">
                    销退采退分析:
                    <asp:DropDownList ID="ddlFenXi" runat="server">
                        <asp:ListItem Value="-1" Text="全部"></asp:ListItem>
