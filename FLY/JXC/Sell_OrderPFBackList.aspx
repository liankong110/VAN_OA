<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sell_OrderPFBackList.aspx.cs"
    Inherits="VAN_OA.JXC.Sell_OrderPFBackList" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="发票单签回列表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlType" runat="server" Width="160px">
                    <asp:ListItem Text="未收到和未开具" Value="3"></asp:ListItem>
                    <asp:ListItem Text="收到" Value="0"></asp:ListItem>
                    <asp:ListItem Text="未收到" Value="1"></asp:ListItem>
                    <asp:ListItem Text="未开具" Value="2"></asp:ListItem>
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:CheckBox ID="cbIsPoFax" runat="server" />不含税
    ...
    <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            <asp:TemplateField HeaderText="">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnReEdit" runat="server" CommandName="ReEdit" CommandArgument='<% #Eval("BackId") %>'
            ...
            <asp:BoundField DataField="BackProNo" HeaderText="签回单号" SortExpression="BackProNo"
                ItemStyle-HorizontalAlign="Center" DataFormatString="{0:yyyy-MM-dd}" />
            <asp:BoundField DataField="FPBackTime" HeaderText="签回日期" SortExpression="FPBackTime"
                ItemStyle-HorizontalAlign="Center" DataFormatString="{0:yyyy-MM-dd}" />
            <asp:TemplateField HeaderText="签回状态">
                <ItemTemplate>
                    <asp:Label ID="FPBackType" runat="server" Text='<%# GetType(Eval("FPBackType")) %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="ProNo" HeaderText="发票单号" SortExpression="ProNo" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="RuTime1" HeaderText="发票日期" SortExpression="RuTime1" ItemStyle-HorizontalAlign="Center"
            ...
            <asp:TemplateField HeaderText="金额">
                <ItemTemplate>
                    <asp:Label ID="Total" runat="server" Text='<%# Eval("Total1") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
