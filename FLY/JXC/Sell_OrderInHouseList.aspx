<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sell_OrderInHouseList.aspx.cs"
    Inherits="VAN_OA.JXC.Sell_OrderInHouseList" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="采购订单列表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="6" style="height: 20px; background-color: #336699; color: White;">销售退货列表
            </td>
        </tr>
        <tr>
            <td>项目编号:
        ...
        <tr>
            ...
            <td>商品编码</td>
            <td>
                <asp:TextBox ID="txtGoodNo" runat="server" Width="350px"></asp:TextBox></td>
        </tr>
        <tr>
            <td>名称/小类/规格：
            </td>
    ...
    <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="ChcekProNo" HeaderText="出库单号" SortExpression="ChcekProNo"
                ItemStyle-HorizontalAlign="Center" />
