<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JXC_SkilllList.aspx.cs"
    Inherits="VAN_OA.JXC.JXC_SkilllList" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="工程技术派工统计报表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
        ...
        <tr>
            <td colspan="4">项目关闭：
               ...
               项目金额
                ...
                反馈得分:  <asp:DropDownList ID="ddlFKDF" runat="server">
                     <asp:ListItem Text="全部" Value="-1"></asp:ListItem>
                     <asp:ListItem Text=">" Value=">"></asp:ListItem>
                     <asp:ListItem Text="<" Value="<"></asp:ListItem>
                     <asp:ListItem Text=">=" Value=">="></asp:ListItem>
                ...
                <asp:TextBox ID="txtFKDF" runat="server" Width="80px"></asp:TextBox>
                 综合得分:  <asp:DropDownList ID="ddlAllScore" runat="server">
                     <asp:ListItem Text="全部" Value="-1"></asp:ListItem>
                     <asp:ListItem Text=">" Value=">"></asp:ListItem>
                     <asp:ListItem Text="<" Value="<"></asp:ListItem>
                     <asp:ListItem Text=">=" Value=">="></asp:ListItem>
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%" ScrollBars="Horizontal">
        <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid" DataKeyNames="Id" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="InvoiceTotal" HeaderText="实到账" DataFormatString="{0:n2}"
                  ...
                  <asp:BoundField DataField="DaoKuanLv" HeaderText="到款率" DataFormatString="{0:n2}"
                    SortExpression="DaoKuanLv" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
               ...
               <%-- <asp:BoundField DataField="ZhangQiTotal" HeaderText="帐期" SortExpression="ZhangQiTotal"
                ...
                <asp:BoundField DataField="INSIDE" HeaderText="INSIDE" SortExpression="INSIDE" ItemStyle-HorizontalAlign="Center">
                 ...
                 <asp:BoundField DataField="loginName" HeaderText="被派工员"  ItemStyle-HorizontalAlign="Center">
                   
                </asp:BoundField>
                 <asp:BoundField DataField="DisDate" HeaderText="派工日期"  ItemStyle-HorizontalAlign="Center" DataFormatString="{0:yyyy-MM-dd}"> 
                  
                </asp:BoundField>
                 <asp:BoundField DataField="NiHours" HeaderText="时间"  ItemStyle-HorizontalAlign="Center">
                    
                </asp:BoundField>
                 <asp:BoundField DataField="MyValue" HeaderText="反馈得分" ItemStyle-HorizontalAlign="Center">
                   
                </asp:BoundField>
                 <asp:BoundField DataField="allScore" HeaderText="综合得分"  ItemStyle-HorizontalAlign="Center">
