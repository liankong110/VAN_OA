    ...
    <form id="form1" runat="server">
        <div>
            <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
                border="1">
                <tr>
                    <td colspan="8" style="height: 20px; background-color: #336699; color: White;">销售出库信息
                    </td>
                </tr>
                <tr>
                    <td>项目编号:
                    ...
                    <td colspan="1">
                        ...
                        发票正负：<asp:DropDownList ID="ddlZhengFu" runat="server">
                            <asp:ListItem Text="正数" Value="1"></asp:ListItem>
                            <asp:ListItem Text="负数" Value="2"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td>项目名称:
                    </td>
