<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DioPOList.aspx.cs" Inherits="VAN_OA.JXC.DioPOList" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
            ...
            <tr>
                ...
                <td>
                    ...
                    AE：<asp:DropDownList ID="ddlUser" runat="server" DataTextField="LoginName" DataValueField="Id"
                    Width="200PX">
                </asp:DropDownList>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlBusType" runat="server" Width="180px">
                        <asp:ListItem Value="-1">全部</asp:ListItem>
                        <asp:ListItem Value="0">未结清</asp:ListItem>
                        <asp:ListItem Value="1">已结清</asp:ListItem>
                    </asp:DropDownList>
                    <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="红色：已结清项目，无色：未结清项目"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="4">
         ...
         <br />--%>
            ...
            <Columns>
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton1" runat="server" CommandName="select" CommandArgument='<% #Eval("ProNo") %>'>选择</asp:LinkButton>
                    </ItemTemplate>
                ...
                <asp:BoundField DataField="GuestName" HeaderText="客户名称" SortExpression="GuestName"
                    ItemStyle-HorizontalAlign="Center" />
                      <asp:BoundField DataField="POStatue4" HeaderText="到款" SortExpression="POStatue4" ItemStyle-HorizontalAlign="Center" />
