<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JXC_REPORTTotalList.aspx.cs"
    Inherits="VAN_OA.JXC.JXC_REPORTTotalList" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="销售报表汇总" %>
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%" ScrollBars="Horizontal">
        <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
            ...
            <Columns>
             ...
             <%--   <asp:BoundField DataField="trueZhangQi" HeaderText="到款期" SortExpression="trueZhangQi"
                    ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>--%>
