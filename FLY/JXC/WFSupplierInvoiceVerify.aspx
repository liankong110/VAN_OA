...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        border="1">
        <tr>
            <td colspan="4" style="height: 20px; background-color: #336699; color: White;">供应商付款单-<asp:Label ID="lblProNo" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td>制单人：
        ...
        <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="已支付" HeaderStyle-Width="3%">
				 ...
				 <asp:TemplateField HeaderText="未支付" HeaderStyle-Width="3%">
                    <ItemTemplate>
                        <asp:Label ID="lblnew_ShengYuZhiJia_1" runat="server" Text='<%# Eval("new_ShengYuZhiJia_1") %>'></asp:Label>
                    </ItemTemplate>
                    <FooterTemplate>
                        <asp:Label ID="lblnew_ShengYuZhiJia_1" runat="server" Text='<%# Eval("new_ShengYuZhiJia_1") %>'></asp:Label>
                    </FooterTemplate>
