<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFCAI_OrderInHouse.aspx.cs" Inherits="VAN_OA.JXC.WFCAI_OrderInHouse"   Culture="auto" UICulture="auto"  MasterPageFile="~/DefaultMaster.Master" Title="订单报批表" %>
...
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
  <asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF" border="1" >
         <tr>
            <td colspan="4" style=" height:20px; background-color:#336699; color:White;">采购入库-<asp:Label ID="lblProNo" runat="server" Text=""></asp:Label></td>
        </tr>      
