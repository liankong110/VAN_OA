<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssessmentREPORTTotalList.aspx.cs"
    Inherits="VAN_OA.JXC.AssessmentREPORTTotalList" Culture="auto" UICulture="auto"
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
        <td  colspan="4">启用时间: <asp:TextBox ID="txtStartTime" runat="server"></asp:TextBox>
    ...
    <asp:Panel ID="Panel2" runat="server" Width="100%" ScrollBars="Horizontal">
        <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SellFPTotal" HeaderText="发票额" DataFormatString="{0:n0}"
                    SortExpression="SellFPTotal" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="InvoiceTotal" HeaderText="实到账" DataFormatString="{0:n0}"
                ...
                <asp:BoundField DataField="TrueLiRun" HeaderText="实际利润" SortExpression="TrueLiRun"
                    ...
                    <asp:BoundField DataField="ZhangNeiDaoTotal" HeaderText="帐内到款" SortExpression="ZhangNeiDaoTotal"
                    DataFormatString="{0:n0}" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                    <asp:BoundField DataField="ZhangNeiQianTotal" HeaderText="帐内欠款" SortExpression="ZhangNeiQianTotal"
                    DataFormatString="{0:n0}" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                    <asp:BoundField DataField="LiRunKouChu" HeaderText="利润扣除" SortExpression="LiRunKouChu"
                    DataFormatString="{0:n0}" ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
                <asp:BoundField DataField="ZhangQiTotal" HeaderText="账期/天" SortExpression="ZhangQiTotal"
                    ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>
              <%--  <asp:BoundField DataField="trueZhangQi" HeaderText="实际到款期" SortExpression="trueZhangQi"
                    ItemStyle-HorizontalAlign="Center">
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                </asp:BoundField>--%>
    ...
    &nbsp; &nbsp;
    利润扣除合计 <asp:Label ID="lblLiRunKouChu" runat="server" Text="0" ForeColor="Red"></asp:Label>
      &nbsp; &nbsp;
    项目纯利合计
     <asp:Label ID="lblChunLiRunKouChu" runat="server" Text="0" ForeColor="Red"></asp:Label>
     &nbsp; &nbsp;
