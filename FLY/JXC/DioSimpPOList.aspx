<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DioSimpPOList.aspx.cs"
    Inherits="VAN_OA.JXC.DioSimpPOList" %>
...
<body style="font-size: 12px;">
    ...
    <div>
        ...
        <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
            DataKeyNames="PONo" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
