<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sell_OrderOutHouseBackList.aspx.cs"
    Inherits="VAN_OA.JXC.Sell_OrderOutHouseBackList" Culture="auto" UICulture="auto"
    MasterPageFile="~/DefaultMaster.Master" Title="出库单签回列表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtProNo" runat="server"></asp:TextBox>出库单据号
                <asp:TextBox ID="txtOutProNo" runat="server"></asp:TextBox>
            </td>
            <td>
                签回状态:
            </td>
    ...
    <asp:GridView ID="gvMain" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="BackTime" HeaderText="签回日期" SortExpression="BackTime"
                ItemStyle-HorizontalAlign="Center" DataFormatString="{0:yyyy-MM-dd}" />
            <asp:TemplateField HeaderText="签回状态">
                <ItemTemplate>
                    <asp:Label ID="BackType" runat="server" Text='<%# GetType(Eval("BackType")) %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="ProNo" HeaderText="出库单据" SortExpression="ProNo" ItemStyle-HorizontalAlign="Center" />
            <asp:BoundField DataField="RuTime" HeaderText="出库日期" SortExpression="RuTime" ItemStyle-HorizontalAlign="Center"
