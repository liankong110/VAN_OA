<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFSell_OrderFPBack.aspx.cs"
    Inherits="VAN_OA.JXC.WFSell_OrderFPBack" Culture="auto" UICulture="auto" MasterPageFile="~/DefaultMaster.Master"
    Title="订单报批表" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    ...
    <script type="text/javascript">
        function ChuKu() {
            var url = "../JXC/DioSell_OrderFPBack.aspx";
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            <td colspan="4" style="height: 20px; background-color: #336699; color: White;">
                发票单签回-<asp:Label ID="lblProNo" runat="server" Text=""></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFPNo" runat="server" Width="200px" ReadOnly="true"></asp:TextBox>
                <font style="color: Red">*</font>
