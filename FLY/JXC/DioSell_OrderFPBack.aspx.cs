...
{
    public partial class DioSell_OrderFPBack : BasePage
    {
        ...
        private void Show()
        {
            string sql = " and Sell_OrderFP.CreateUserId= " + Session["currentUserId"];
            sql = "";
            ...
            {
                sql += string.Format(" and Sell_OrderFP.POName like '%{0}%'", ttxPOName.Text.Trim());
            }
            ...
            List<Sell_OrderFP> cars = this.POSer.GetListArray_Back(sql);
