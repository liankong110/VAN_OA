...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="SampleContent">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td colspan="3">
                ...
                或者
                <asp:TextBox ID="txtNameOrTypeOrSpecTwo" runat="server" Width="100PX"></asp:TextBox>  项目类别：
                ...
                帐期分析:   <asp:DropDownList ID="ddlZhangqi" runat="server">
                    <asp:ListItem Value="-1" Text="全部"></asp:ListItem>
                    <asp:ListItem Value=">">实际帐期>帐期截止期</asp:ListItem>
                    <asp:ListItem Value="<=">实际帐期<=帐期截止期</asp:ListItem>
                </asp:DropDownList>

                发票状态： <asp:DropDownList ID="ddlFPState" runat="server" >
    ...
    --项目信息<br/>
    商品编码: <asp:TextBox ID="txtGoodNo1" runat="server" Width="100px"></asp:TextBox>名称/小类/规格: <asp:TextBox ID="txtNameOrTypeOrSpec1" runat="server" Width="100PX"></asp:TextBox>
                或者
    ...
    <asp:DropDownList ID="ddlGoodUnit" runat="server">
                ...
                备注: <asp:TextBox ID="txtRemark" runat="server" Width="100px"></asp:TextBox>
