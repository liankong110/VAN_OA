<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFRole.aspx.cs" Inherits="VAN_OA.WFRole"
    MasterPageFile="~/DefaultMaster.Master" Title="角色查询" %>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" bordercolorlight="#999999" bordercolordark="#FFFFFF"
        ...
        <tr>
            ...
            <td>
                ...
                <asp:Button ID="btnAdd" runat="server" Text="添加角色" BackColor="Yellow" OnClick="btnAdd_Click" />
            </td>
        </tr>
    </table>
    <br>
    <asp:GridView ID="gvList" runat="server" BorderColor="#FBFBFB" BorderStyle="Solid"
        DataKeyNames="RID" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
