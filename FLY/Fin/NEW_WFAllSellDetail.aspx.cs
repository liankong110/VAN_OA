...
", endDate.ToString("yyyy-MM-dd"), aeSql, fristDate.ToString("yyyy-MM-dd"), col1, kouInvoTotal, tiaojian1, tiaojian2, tiaojian3, tiaojian4);
   ...
   <NumberFormat ss:Format='@'/></Style>");
            ...
            foreach (var u in user)
            {
                ...
                GetNumber(model.KouTotal_QZ);
                GetNumber(model.SellTotal_ZZ);
                GetNumber(model.MaoLi_ZZ);
                GetNumber(model.KouTotal_ZZ);
                ...
                report2_String += GetNumber_String(model.KouTotal_QXZ);
                report2_String += GetNumber_String(model.SellTotal_ZXZ);
                report2_String += GetNumber_String(model.MaoLi_ZXZ);
                report2_String += GetNumber_String(model.KouTotal_ZXZ);
                ...
                report2_String += GetNumber_String((X19 - model.KouTotal_QXZ).ToString("n4"));
                report2_String += GetNumber_String(X20.ToString("n4"));
                report2_String += GetNumber_String((X20 - model.KouTotal_ZXZ).ToString("n4"));
                report2_String += "</Row>";
                ...
                GetNumber(X1.ToString());
                GetNumber(model.SellTotal_QZ);
                GetNumber(model.TureliRun_QZ);
                GetNumber(model.KouTotal_QZ);
                GetNumber(model.SellTotal_ZZ);
                GetNumber(model.TureliRun_ZZ);
                GetNumber(model.KouTotal_ZZ);
                GetNumber(X6.ToString("n4"));
                GetNumber(X7.ToString("n4"));
                GetNumber(X8.ToString("n4"));
                ...
                report3_String += GetNumber_String(X11.ToString("n4"));
                report3_String += GetNumber_String(model.SellTotal_QXZ);
                report3_String += GetNumber_String(model.TureliRun_QXZ);
                report3_String += GetNumber_String(model.KouTotal_QXZ);
                report3_String += GetNumber_String(model.SellTotal_ZXZ);
                report3_String += GetNumber_String(model.TureliRun_ZXZ);
                report3_String += GetNumber_String(model.KouTotal_ZXZ);
                report3_String += GetNumber_String(X16.ToString("n4"));
                report3_String += GetNumber_String(X17.ToString("n4"));
                report3_String += GetNumber_String(X18.ToString("n4"));
                report3_String += GetNumber_String(X19.ToString("n4"));
                report3_String += GetNumber_String((X19 - model.KouTotal_QXZ).ToString("n4"));
                report3_String += GetNumber_String(X20.ToString("n4"));
                report3_String += GetNumber_String((X20 - model.KouTotal_ZXZ).ToString("n4"));
                report3_String += "</Row>";
