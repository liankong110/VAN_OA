...
{
    public partial class NEW_WFAllSellDetail : System.Web.UI.Page
    {
...
", endDate.ToString("yyyy-MM-dd"), aeSql, fristDate.ToString("yyyy-MM-dd"), col1, kouInvoTotal, tiaojian1, tiaojian2, tiaojian3, tiaojian4));
   ...
   <NumberFormat ss:Format='@'/></Style>");
            ...
            foreach (var u in user)
            {
                ...
                Response.Write(string.Format("<Row ss:AutoFitHeight='1' ss:style='background-color: #336699; color: White;'>"));
                ...
                Response.Write(string.Format("<Row ss:AutoFitHeight='1' ss:colspan='21' ss:style='background-color: #336699; color: White;'>"));
